      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <motion.h4
              className="font-bold mb-4 text-yellow-green text-sm uppercase"
              initial={{ opacity: 0 }}
        ...
        {/* Bottom Section */}
        <motion.div
          className="border-t border-cyan/20 pt-8 flex flex-col md:flex-row items-center justify-between"
          ...
          >
            {[
              ...
              >
                ...
                <svg
                  className="w-6 h-6 group-hover:text-cyan"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                  <path d={social.path} />
