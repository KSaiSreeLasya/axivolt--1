...
export const handleSitemap: RequestHandler = (req, res) => {
  ...
  const routes = [
    ...
    { path: "/solutions/solar/residential", priority: "0.8", changefreq: "monthly" },
    { path: "/solutions/solar/commercial", priority: "0.8", changefreq: "monthly" },
    { path: "/solutions/solar/government", priority: "0.8", changefreq: "monthly" },
    { path: "/solutions/wind", priority: "0.8", changefreq: "monthly" },
    { path: "/solutions/energy-storage", priority: "0.8", changefreq: "monthly" },
