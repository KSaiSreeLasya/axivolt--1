        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-black hover:text-cyan transition">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/careers" className="text-black hover:text-cyan transition">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/solutions/solar/residential" className="text-black hover:text-cyan transition">
                  Solar Residential
                </Link>
              </li>
              <li>
                <Link to="/solutions/solar/commercial" className="text-black hover:text-cyan transition">
                  Solar Commercial
                </Link>
              </li>
              <li>
                <Link to="/solutions/wind" className="text-black hover:text-cyan transition">
                  Wind
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contact" className="text-black hover:text-cyan transition">
                  Contact Us
                </Link>
              </li>
              <li>
