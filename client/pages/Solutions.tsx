          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {solutions.map((solution) => {
              ...
              return (
                ...
                >
                  {/* Icon */}
                  <div className={`w-16 h-16 rounded-lg ${solution.color} flex items-center justify-center mb-6`}>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6 pb-6 border-b border-border">
                    <div>
                      <p className="text-2xl font-bold text-cyan">{solution.metric1.value}</p>
                      <p className="text-xs text-gray-400">{solution.metric1.label}</p>
                    </div>
                    <div>
                      <p className="text-2xl font-bold text-yellow-green">{solution.metric2.value}</p>
                      <p className="text-xs text-gray-400">{solution.metric2.label}</p>
                    </div>
                  </div>
