  ...
  const solutions = [
    {
      ...
      image: "https://images.unsplash.com/photo-1617788386602-11c0c51c18e0?w=600&h=400&fit=crop",
    },
    {
      title: "Infrastructure 2",
      image: "https://images.unsplash.com/photo-1506901925346-21bda4d32df4?w=600&h=400&fit=crop",
    },
    {
      title: "Fleet Charging 3",
      image: "https://images.unsplash.com/photo-1557804506-669714d2e9d8?w=600&h=400&fit=crop",
    },
  ];
  ...
  const offerings = [
    {
      ...
      icon: Plug,
      description: "Design and deployment of charging infrastructure for commercial, fleet and public spaces.",
      features: [
    ...
    },
    {
      ...
      icon: Zap,
      description: "AC and DC fast charging deployments, smart charging and payment integrations.",
      features: [
        "AC & DC fast charging deployments",
        "Smart charging and payment integrations",
      ],
    ...
    },
    {
      ...
      icon: Truck,
      description: "Turnkey solutions for bus, truck and commercial fleet electrification.",
      features: [
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">EV Stations Offerings</h2>
          </div>
            ...
            {offerings.map((offering) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-gray-300 text-sm mb-6">{offering.description}</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-green-400 rounded-2xl p-12 text-center">
          <h2 className="text-3xl font-bold text-background mb-4">Deploy EV charging at scale</h2>
