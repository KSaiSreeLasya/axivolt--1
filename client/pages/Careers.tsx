...
import { ArrowRight, Briefcase, CheckCircle, Users, Award, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8">
              Join a passionate team of innovators, engineers, and sustainability experts working together to revolutionize renewable energy solutions.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, idx) => (
              <div key={idx} className="bg-card rounded-lg p-6 border border-border hover:border-cyan transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400">
              Find your next opportunity and help shape the future of renewable energy
            </p>
          </div>

          <div className="space-y-4">
            {jobs.map((job, idx) => (
              <div key={idx} className="bg-card rounded-lg border border-border p-6 hover:border-cyan transition-all flex items-center justify-between">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit, idx) => {
              ...
              return (
                <div key={idx} className="bg-card rounded-lg p-8 border border-border text-center hover:border-cyan transition-all">
      ...
      <section className="py-20 bg-background/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Life at AXIVOLT</h2>
            <p className="text-gray-400">
              Get a glimpse into our vibrant, inclusive, and empowering workplace
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-lg overflow-hidden border border-border hover:border-cyan transition-all">
              ...
              <div className="p-6">
                <h3 className="text-lg font-bold mb-2">Learning & Development</h3>
                <p className="text-sm text-gray-400">
