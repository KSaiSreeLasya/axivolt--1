      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8 text-black">
          <section>
            ...
            <p className="mb-4">
              AXIVOLT ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong>Personal Data:</strong> Name, email address, phone number, postal address, and other information you provide when contacting us or requesting quotes.</li>
              <li><strong>Technical Data:</strong> IP address, browser type, operating system, and pages visited.</li>
              <li><strong>Usage Data:</strong> How you interact with our website, including the time and duration of your visit.</li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-bold text-cyan mb-4">4. Data Protection and Security</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cyan mb-4">5. Third-Party Disclosure</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-cyan mb-4">6. Your Rights</h2>
          ...
          <section>
            ...
            <p className="mb-4">
              Our website uses cookies to enhance your browsing experience. You can choose to disable cookies through your browser settings, but this may limit your ability to use certain features of our website.
            </p>
          </section>
